...
const Learning = () => {
  return (
    ...
    <div className='card-lrg'>
     ...
     <CardLrg img ={data.img} name = {data.name} desc={data.desc}/>
     <CardLrg img ={data2.img} name = {data2.name} desc={data2.desc}/>
     <CardLrg img ={data3.img} name = {data3.name} desc={data3.desc}/>
     </div>
